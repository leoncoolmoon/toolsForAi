...
**举例 prompt：**
> 我们来进行模型性能盲测，以下是测试题以及回答。你列表比较一下 8 个模型的回答优劣以及耗时。  
> 第一部分是简单提问检测服务稳定性，结果如下：  
> 时间 模型 tok/s TTFT Gen P C Stop  
> 09:27:23 nvidia1 8.1 374 1.61 0 13 done  
> 09:27:17 nvidia2 8.8 9610 13.40 0 118 done  
> 09:26:57 nvidia3 46.8 268 2.50 0 117 done  
> 09:26:38 nvidia4 43.7 754 1.01 0 44 done  
> 09:26:34 nvidia4 0.0 0 1.16 0 0 done  
> 09:26:23 nvidia5 14.4 1725 8.20 0 118 done  
> 09:25:58 nvidia6 45.9 547 2.46 0 113 done  
> 09:25:51 nvidia7 76.5 342 1.57 0 120 done  
> 09:25:36 nvidia8 7.6 1447 13.66 0 104 done  
> 
> 第二部分是问答，见上传文件。  
> 测试的目的是找到合适驱动 agent 的模型，并且根据其回答品质和速度排序，品质好并且速度快的模型优先。

- 💡 **小技巧**：将两个工具导出的测试结果（观测站的指标数据 + 批量测试台的回答耗时）汇总后交给大模型分析，可快速获得模型排名、性价比评估和改进建议。
---
